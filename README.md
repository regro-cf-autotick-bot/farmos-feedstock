...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/farmos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12728&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/farmos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `farmos` can be installed with:

```
conda install farmos
```

It is possible to list all of the versions of `farmos` available on your platform with:
